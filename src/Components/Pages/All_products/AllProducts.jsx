...
const AllProducts = () => {
  ...
  return (
    <div className="relative">
      <div className="sticky top-[56px] z-40 text-center md:top-[64px] grid grid-cols-4 bg-gray-200">
        <input id="r1" className="peer/r1 hidden " type="radio" name="d" />
        <label
          className=" hover:bg-gray-300 peer-checked/r1:bg-gray-300"
          htmlFor="r1"
        >
          All
        </label>
        ...
        <label
          className=" hover:bg-gray-300 peer-checked/r2:bg-gray-300"
          htmlFor="r2"
        >
          Trendings
        </label>
        ...
        <label
          className=" hover:bg-gray-300 peer-checked/r3:bg-gray-300"
          htmlFor="r3"
        >
          Featured
        </label>
        ...
        <label
          className=" hover:bg-gray-300 peer-checked/r4:bg-gray-300"
          htmlFor="r4"
        >
          Favorites
        </label>
